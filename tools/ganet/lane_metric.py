...
class LaneMetricCore(object):
    ...
    def __call__(self, gt_result, pr_result, *args, **kwargs):
        ...
        :return:
        """
        result = self.eval_single(gt_result, pr_result, *args, **kwargs)
        self.result_record.append(result)

    def eval_single(self, gt_result, pr_result, *args, **kwargs):
    ...
    def result_single(self):
        cur_result = self.result_record[-1]
        hit_num = cur_result['hit_num']
        pr_num = cur_result['pr_num']
        gt_num = cur_result['gt_num']
