...
sample_gt_points = [41, 25, 18]              # check
...
# ori_scale = (2560, 1440)  # for culane
# crop_bbox = [0, 180, 2560, 1440]
img_scale = (800, 320)
...
log_level = 'INFO'
work_dir = './work_dirs/curvelane/small'
load_from = None
resume_from = None
# workflow = [('train', 500), ('val', 1)]

from configs.curvelane.common import *
